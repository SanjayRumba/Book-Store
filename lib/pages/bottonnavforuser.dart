...
import 'package:book_shop/pages/settingsforuser.dart';
import 'package:book_shop/pages/userhomepage.dart';
import 'package:flutter/material.dart';

class BottomNavForUser extends StatefulWidget {
  const BottomNavForUser({Key? key}) : super(key: key);

  @override
  State<BottomNavForUser> createState() => _BottomNavForUserState();
}

class _BottomNavForUserState extends State<BottomNavForUser> {
  int selectedTab = 0;
  List<Widget> pages = [
    UserHomepage(),
    // BookPage(),
